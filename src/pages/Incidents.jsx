                ...
                return (
                  <tr key={item.id} className="hover:bg-gray-50 transition duration-150">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex px-3 py-1 text-xs font-semibold rounded-full ${severityColor}`}>
                        {sev}
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex px-3 py-1 text-xs font-semibold rounded-full ${statusColor}`}>
                        {item.status}
                      </span>
                    </td>
